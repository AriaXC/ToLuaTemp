...
local function UpdateTimer(event)
    ...
    if #startingList == 0 then
        ...
        eventMgr:RemoveEventListener(EventStr.UPDATE,self.handlerTime,self)
...
function Timer:Start()
    ...
    if self.repeatCount == 0 or self.currentCount < self.repeatCount then
        ...
        self.handlerTime = eventMgr:AddEventListener(EventStr.UPDATE,handler(self.MyUpdate,UpdateTimer))
    end
end
